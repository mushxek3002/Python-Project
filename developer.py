...
# This part is image labels setting start 
        ...
        det_b1_1 = Button(bg_img,text="Ansari Uzair",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        ...
        att_b1_1 = Button(bg_img,text="Mussaib Shaikh ",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
